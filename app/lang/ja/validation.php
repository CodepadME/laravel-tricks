...
return array(
	...
	*/
	...
	"alpha"            => ":attributeはアルファベッドのみがご利用できます。s",
	...
	"required_without" => ":attributeは:valuesが存在している場合に必須となります。",
	"same"             => ":attributeは:valuesが存在していない場合に必須となります。",
	"size"             => array(
		"numeric" => ":attributeには:sizeを指定してください。",
		"file"    => ":attributeのファイルは、:sizeキロバイトでなくてはなりません。",
		"string"  => ":attributeのファイルは、:sizeキロバイトでなくてはなりません。",
		"array"   => ":attributeは:size文字で指定してください。",
	),
